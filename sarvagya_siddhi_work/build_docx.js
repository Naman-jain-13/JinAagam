...
const OUT_FILE = path.join(__dirname, '..', 'Laghu_Sarvagya_Siddhi_Vyakhya.docx');
...
const titleChildren = [
  ...
  new Paragraph({
    ...
    children: [ new TextRun({
      text: 'अनुच्छेदशः मूल संस्कृत पाठ, हिन्दी अनुवाद, जैनागम-सम्मत विस्तृत व्याख्या, सरल उदाहरण एवं तुलनात्मक तालिका सहित। आधार: 21-पृष्ठीय स्कैन (मुद्रित पृष्ठ १०७–१२७)। यह कार्य बैचों में प्रगतिशील है; प्रगति-विवरण के लिए sarvagya_siddhi_work/progress.md देखें।',
