...
NAMES = [
    ...
    # 'अनन्तवीर्य' / 'अनंतवीर्य' deliberately NOT listed for this ग्रन्थ: in नयचक्र every occurrence is
    # the quality (अनन्तज्ञान, अनन्तदर्शन, अनन्तसुख, अनन्तवीर्य — the अनन्तचतुष्टय), not the आचार्य.
    # Honouring it would print 'अनन्तसुख और श्री अनन्तवीर्य स्वामी' mid-sentence. Restore the name if a
    # later ग्रन्थ in this series actually cites आचार्य श्री अनन्तवीर्य.
