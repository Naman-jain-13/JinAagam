...
const OUT_FILE = path.join(__dirname, 'vyakhya', 'Laghu_Sarvagya_Siddhi_Vyakhya.docx');
...
const titleChildren = [
  ...
  new Paragraph({
    alignment: AlignmentType.CENTER,
    spacing: { after: 300 },
    children: [ new TextRun({ text: 'लघु-सर्वज्ञ-सिद्धिः', bold: true, size: 44, font: FONT, color: '1F4E79' }) ]
  }),
  new Paragraph({
    alignment: AlignmentType.JUSTIFIED,
    spacing: { after: 160, line: 340 },
    children: [ new TextRun({
      text: 'अनुच्छेदशः मूल संस्कृत पाठ, हिन्दी अनुवाद, जैनागम-सम्मत विस्तृत व्याख्या, सरल उदाहरण एवं तुलनात्मक तालिका सहित। आधार: 21-पृष्ठीय स्कैन (मुद्रित पृष्ठ १०७–१२७)। यह कार्य बैचों में प्रगतिशील है; प्रगति-विवरण के लिए granth/laghu-sarvagya-siddhi/progress.md देखें।',
