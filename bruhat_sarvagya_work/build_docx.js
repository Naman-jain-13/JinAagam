...
const OUT_FILE = path.join(__dirname, '..', 'Bruhat_Sarvagya_Siddhi_Vyakhya.docx');
...
const titleChildren = [
  ...
  new Paragraph({
    ...
    children: [ new TextRun({
      text: 'अनुच्छेदशः मूल संस्कृत पाठ, हिन्दी अनुवाद, जैनागम-सम्मत विस्तृत व्याख्या, सरल उदाहरण एवं तुलनात्मक तालिका सहित। आधार: 75-पृष्ठीय स्कैन (मुद्रित पृष्ठ १३०–२०४ अनुमानित) — Laghu Sarvagya Siddhi के ठीक बाद, उसी संग्रह-ग्रन्थ में। यह कार्य बैचों में प्रगतिशील है; प्रगति-विवरण के लिए bruhat_sarvagya_work/progress.md देखें।',
