...
//
// Output: ../Laghu_Sarvagya_Siddhi_Vyakhya.docx  (TOC + PAGE fields; run finalize_word.ps1 to update fields & export PDF)
...
const OUT_FILE = process.env.OUT || path.join(__dirname, '..', 'Bruhat_Sarvagya_Siddhi_Vyakhya.docx');
